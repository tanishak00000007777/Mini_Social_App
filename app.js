...
app.post('/upload', isLoggedIn, upload.single("image"), async (req, res) => {
    try {
        if (!req.file) return toastRedirect(res, '/profile/upload', "Please choose an image first.", 'error');
        ...
        console.error(err);
        toastRedirect(res, '/profile/upload', "Couldn't upload that image. Please try again.", 'error');
    }
});
